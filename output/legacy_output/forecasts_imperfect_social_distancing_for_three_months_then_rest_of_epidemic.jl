...
"""
SCENARIO 1 --- Imperfect social distancing for 3 months:
...
results_1SI_three_months = KenyaCoV.run_scenario(P,prob,1000,reduced_treatment_rates,both_cbs)
@save joinpath(homedir(),"Github/KenyaCoVOutputs/results_1SI_three_months.jld2") results_1SI_three_months


println("Finished 1 imperfect social distancing for 3 months")



"""
SCENARIO 2 --- Imperfect social distancing:
* No age-specific susceptibilties --- its disease difference
...
results_2SI_three_months = KenyaCoV.run_scenario(P,prob,1000,reduced_treatment_rates,both_cbs)
@save joinpath(homedir(),"Github/KenyaCoVOutputs/results_2SI_three_months.jld2") results_2SI_three_months


println("Finished 2 imperfect social distancing for 3 months")
"""
...
results_3SI_three_months = KenyaCoV.run_scenario(P,prob,1000,reduced_treatment_rates,both_cbs)
@save joinpath(homedir(),"Github/KenyaCoVOutputs/results_3SI_three_months.jld2") results_3SI_three_months


println("Finished 3 imperfect social distancing for 3 months")


"""
SCENARIO 4 --- Social distancing for 3 months:
* No age-specific susceptibilties --- its disease difference
...
results_4SI_three_months = KenyaCoV.run_scenario(P,prob,1000,reduced_treatment_rates,both_cbs)
@save joinpath(homedir(),"Github/KenyaCoVOutputs/results_4SI_three_months.jld2") results_4SI_three_months


println("Finished 4 imperfect social distancing for 3 months")


"""
SCENARIO 5 --- Social distancing for 3 months:
* No age-specific susceptibilties --- its disease difference
...
results_5SI_three_months = KenyaCoV.run_scenario(P,prob,1000,reduced_treatment_rates,both_cbs)
@save joinpath(homedir(),"Github/KenyaCoVOutputs/results_5SI_three_months.jld2") results_5SI_three_months


println("Finished 5 imperfect social distancing for 3 months")
