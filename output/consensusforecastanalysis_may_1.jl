...
sims = sims_open_schools_august #Change this to the current simulation group
file_tag = "open_schools_august" #File name tags
title_tag = " (SD + opening schools in August)" #For changing the title of plots
...
df = print_onset_report(first_times,peak_A,peak_A_value,peak_M,peak_M_value,peak_V,peak_V_value,names,"peak_report_"*file_tag*".csv")
...
display(plt_deaths)
savefig(plt_cases,"cases_"*file_tag*".png")
savefig(plt_deaths,"deaths_"*file_tag*".png")
...
plt2
savefig(plt1,"Hospital_capacity_"*file_tag*".png")
savefig(plt2,"ICU_capacity_"*file_tag*".png")
...
plot!(plt_usage_nairobi,[0,365],[spare_capacity_H_by_county[Nairobi_index+1],spare_capacity_H_by_county[Nairobi_index+1]],
        title = "Nairobi"*title_tag,lw = 2,ls = :dash,lab = "spare hosp. capacity",color = :blue)

plot!(plt_usage_nairobi,[0,365],[spare_capacity_ICU_by_county[Nairobi_index+1],spare_capacity_ICU_by_county[Nairobi_index+1]],
        title = "Nairobi"*title_tag,lw = 2,ls = :dash,lab = "spare ICU capacity",color = :green)

savefig(plt_incidence_nairobi,"nairobi_incidence_"*file_tag*".png")
savefig(plt_usage_nairobi,"nairobi_health_usage_"*file_tag*".png")
...
# plot!(plt_usage_nairobi,[0,365],[spare_capacity_H_by_county[30+1],spare_capacity_H_by_county[30+1]],
#         title = "Nairobi (SD + regional lockdown relaxed May 16th)",lw = 2,ls = :dash,lab = "spare hosp. capacity",color = :blue)
plot!(plt_usage_mombasa,[0,365],[spare_capacity_H_by_county[Mombassa_index+1],spare_capacity_H_by_county[Mombassa_index+1]],
        title = "Mombasa"*title_tag,lw = 2,ls = :dash,lab = "spare hosp. capacity",color = :blue)

plot!(plt_usage_mombasa,[0,365],[spare_capacity_ICU_by_county[Mombassa_index+1],spare_capacity_ICU_by_county[Mombassa_index+1]],
        title = "Mombasa"*title_tag,lw = 2,ls = :dash,lab = "spare ICU capacity",color = :green)

savefig(plt_incidence_mombasa,"mombasa_incidence_"*file_tag*".png")
savefig(plt_usage_mombasa,"mombasa_health_usage_"*file_tag*".png")
...
savefig(plt_incidence_rest,"rest_of_country_incidence_"*file_tag*".png")
savefig(plt_usage_rest,"rest_of_country_health_usage_"*file_tag*".png")
