...
println("Scenario A: SARS-like data loaded")
...
results_A1 = KenyaCoV.run_scenario(P,prob,1000,treatment_rates,cb_iso_limit)

@save joinpath(homedir(),"Github/KenyaCoVOutputs/results_A1.jld2") results_A1
println("Scenario A: SARS-like A2 finished")
