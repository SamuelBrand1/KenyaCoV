...
%          {'timetopeak',[85 90],'FaceColor',[1 0 0]*(1-x(7)) + [0 0 1]*x(7) });
   ColoredConstituencies = makesymbolspec('Polygon',...
         {'timetopeak',[55 60],'FaceColor',map(round(x(1))) },...
         {'timetopeak',[60 65],'FaceColor',map(round(x(2))) },...
         {'timetopeak',[65 70],'FaceColor',map(round(x(3))) },...      
         {'timetopeak',[70 75],'FaceColor',map(round(x(4))) },...              
         {'timetopeak',[75 80],'FaceColor',map(round(x(5))) },...
         {'timetopeak',[80 85],'FaceColor',map(round(x(6))) },...
         {'timetopeak',[85 90],'FaceColor',map(round(x(7))) });
