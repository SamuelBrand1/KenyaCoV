...
plot(sol_tl_no_controls.t,cum_I_no_controls,lab="No control measures")
plot!(sol_tl_halved_after_week.t,cum_I_halved_after_week,lab="Flights halved after one week")
plot!(sol_tl_quartered_after_week.t,cum_I_quartered_after_week,lab="Flights quartered after one week")
plot!(sol_tl_shutdown_after_week.t,cum_I_shutdown_after_week,lab="All flights stopped after one week")
