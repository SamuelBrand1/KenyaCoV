...
###########
sessions=[30,31,32,33,34,35]

Κ_max_capacity_KENYA=[0,0,0,0,0,0]; Κ_max_capacity_Nairobi=[0,0,0,0,0,0]
Κ_max_capacity_Kilifi=[0,20,50,500,1e3,1e4]#1e3,5e3,1e4];#Κ_max_capacity_Kilifi=[1e3,1e3,1e3]
...
#=run_session(1,0,0,1e3,50,0,n_traj,ϵ,σ,γ,δ,β)
run_session(2,0,0,1e3,50,.25,n_traj,ϵ,σ,γ,δ,β)
run_session(3,0,0,1e3,50,.5,n_traj,ϵ,σ,γ,δ,β)
run_session(4,0,0,1e3,50,.75,n_traj,ϵ,σ,γ,δ,β)
run_session(5,0,0,1e3,50,.8,n_traj,ϵ,σ,γ,δ,β)
run_session(6,0,0,1e3,50,.9,n_traj,ϵ,σ,γ,δ,β)
run_session(7,0,0,1e3,50,.95,n_traj,ϵ,σ,γ,δ,β)
=#
