...
function run_combined_scenarios(folder,ϵ,σ,γ,δ,β,R₀,Κ_max_capacity_KENYA,Κ_max_capacity4,first_sc_nb,τₚ_list,stop_Q_list,Κ_max_capacity12_list,κ_per_event4_list,IDs_cfirst_list,n_traj,dt)
    ...
    for stop_Q in stop_Q_list, τₚ in τₚ_list, Κ_max_capacity12 in Κ_max_capacity12_list, κ_per_event4 in κ_per_event4_list, IDs_cfirst in IDs_cfirst_list
        ...
        sessionParams=KenyaCoV_contacts.SessionParams(sc_nb=sc_nb,n_traj=n_traj,R₀=R₀,τₚ=τₚ,stop_Q=stop_Q,Κ_max_capacity12=Κ_max_capacity12,κ_per_event4=κ_per_event4,IDs_cfirst=IDs_cfirst,
...
println("\nR₀,ϵ,σ,γ,δ,β=",r_R₀,",",ϵ,",",σ,",",γ,",",δ,",",β,"\n")

###########
Κ_max_capacity_KENYA=0; Κ_max_capacity4=0#Κ_max_capacity_Nairobi
τₚ_list=[.9]
stop_Q_list=[false]    #****5 do we stop detecting after we stopped tracing
Κ_max_capacity12_list=[1e3,1e4,5e4,1e5]#,1e6]#Κ_max_capacity_Kilifi_list
κ_per_event4_list=[100]#,200]
IDs_cfirst_list=[true]#,false]
n_traj=10

folder="./contacts/results_session1/";    first_sc_nb=95
