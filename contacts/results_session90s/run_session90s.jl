...
σ = 1/rand(d_incubation)
γ = 1/2.5
δ = 0.2
#β = rand(d_R₀)*γ/(δ + ϵ*(1-δ))
β = r_R₀*γ/(δ + ϵ*(1-δ))
println("ϵ,σ,γ,δ,β=",ϵ,σ,γ,δ,β,"\n")
###########
...
run_session(90,0,0,1e3,50,τₚ_list,n_traj,ϵ,σ,γ,δ,β)
run_session(91,0,0,5e3,50,τₚ_list,n_traj,ϵ,σ,γ,δ,β)
run_session(92,0,0,1e4,50,τₚ_list,n_traj,ϵ,σ,γ,δ,β)
run_session(93,0,0,1e3,100,τₚ_list,n_traj,ϵ,σ,γ,δ,β)
run_session(94,0,0,5e3,100,τₚ_list,n_traj,ϵ,σ,γ,δ,β)
run_session(95,0,0,1e4,100,τₚ_list,n_traj,ϵ,σ,γ,δ,β)
