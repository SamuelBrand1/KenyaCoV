...
n_s = 12#9 #global defining number of state     #****
...
n_ta = 16#8 #global defining number of events per location and age group    #****
...
include("types_contacts.jl");#include("types.jl");  #****
include("../src/regularjumps.jl");
include("agestructurejumps_contacts.jl")#include("agestructurejumps.jl")    #****
