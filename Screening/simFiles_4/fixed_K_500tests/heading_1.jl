...
###### PARAMS TO MODIFY
    code_folder="/home/gemvi/rabia_aziza_midasnetwork_us/julia_projects/2020-07-22_KenyaCoV/Screening/simFiles_4/fixed_K_500tests/"
        code_folder="./Screening/simFiles_4/fixed_K_500tests/"
    output_folder="./Screening/output_fixed_K_500tests/"
    n_traj=100
    ϵ=1.
    strategy_nb_tests=500#1000
    #nb_months=1
    is_distributed=true
    R0_is_random=false
