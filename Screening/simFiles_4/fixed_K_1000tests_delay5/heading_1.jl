...
push!(LOAD_PATH, "./src")
    ...
    #=@everywhere=#
    using Parameters,Distributions,DifferentialEquations,JLD2,DataFrames,FileIO,MAT,RecursiveArrayTools,CSV,Revise
#@everywhere begin
...
###### PARAMS TO MODIFY
    code_folder="/home/gemvi/rabia_aziza_midasnetwork_us/julia_projects/2020-07-22_KenyaCoV/Screening/simFiles_4/fixed_K_1000tests_delays5/"
        code_folder="./Screening/simFiles_4/fixed_K_1000tests_delay5/"
    output_folder="./Screening/output_fixed_K_1000tests_delay5/"
    n_traj=1
    ϵ=1.
...
######
    ...
    P_0.screening_delay=5;    P_0.clear_quarantine=14
