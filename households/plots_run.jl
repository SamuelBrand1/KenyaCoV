...
##########  Verify curves  HH
folders=["./households/session40_5sims/","./households/session41_5sims/","./households/session42_5sims/","./households/session43_5sims/"];
plot_folder="./households/session40_5sims/testcurves/";
curves(folders,plot_folder)
