...
@everywhere push!(LOAD_PATH, "./src")
    @everywhere push!(LOAD_PATH, "./ScreeningR")
...
@everywhere begin
        ...
        include("./ScreeningR/callbacks_screening.jl")
###### PARAMS TO MODIFY
    code_folder="/home/gemvi/rabia_aziza_midasnetwork_us/julia_projects/2020-07-22_KenyaCoV/ScreeningR/simFiles_4/rand_K_1000tests/"
        code_folder="./ScreeningR/simFiles_4/rand_K_1000tests/"
    output_folder="./ScreeningR/output_rand_K_1000tests/"
    n_traj=10
    ϵ=1.
